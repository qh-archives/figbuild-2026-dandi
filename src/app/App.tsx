...
export default function App() {
  ...
  return (
    <div className="size-full flex items-center justify-center bg-zinc-900 overflow-hidden font-['Instrument_Sans',sans-serif]">
      {/* Wrapper sized to the visually-rendered dimensions so flexbox centering stays correct */}
      <div style={{ width: FRAME_W * scale, height: FRAME_H * scale, position: "relative", flexShrink: 0 }}>
      <div className="relative" style={{ width: FRAME_W, height: FRAME_H, transform: `scale(${scale})`, transformOrigin: "top left", position: "absolute", top: 0, left: 0 }}>
        <img
