...
import svgPaths from "./svg-3y26iv8d5o";
...
export default function IPhone() {
  return (
    <div className="app-bg relative size-full" data-name="iPhone 16 - 67">
      ...
      <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-[20px] top-[125px] w-[353px]">
        <div className="gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(2,fit-content(100%))] relative shrink-0 w-full">
          ...
          >
            ...
            <div className="-translate-x-1/2 absolute content-stretch flex flex-col font-['Instrument_Sans',sans-serif] font-normal gap-[4px] h-[75px] items-start leading-[0] left-[calc(50%-0.25px)] pt-[20px] px-[12px] top-0 w-[171px]">
              ...
              <div className="content-stretch flex gap-[4px] items-end relative shrink-0 w-full">
                ...
                <div
                  className="flex flex-col h-[28px] justify-center relative shrink-0 text-[10px] text-[rgba(0,0,0,0.5)] w-[22px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
            ...
            <div className="absolute h-[52.5px] left-[20px] top-[94px] w-[130.5px]">
              <div className="absolute inset-[-5.44%_-0.6%_-0.95%_-0.67%]">
                <svg
                  className="block size-full"
                  fill="none"
                  preserveAspectRatio="none"
                  viewBox="0 0 132.154 55.8498"
                >
                  <path
                    d={svgPaths.p351bd48}
                    id="Vector 127"
                    stroke="url(#paint0_linear_10_574)"
                    strokeOpacity="0.75"
                    strokeWidth="2"
                  />
                  <defs>
          ...
          >
            ...
            <div className="absolute bottom-[20px] gap-x-[3px] gap-y-[10px] grid grid-cols-[____minmax(0,1fr)_fit-content(100%)_fit-content(100%)_fit-content(100%)] grid-rows-[repeat(1,fit-content(100%))] h-[24px] left-[0.5px] overflow-clip pb-[20px] px-[12px] w-[170px]">
              ...
              <div className="bg-[#75e886] col-2 h-[24px] rounded-[3px] row-1 shrink-0 w-[37px]" />
          ...
          >
            ...
            <div className="absolute h-[49px] left-[20px] top-[39px] w-[67px]" />
            ...
            <div
              className="absolute flex items-center justify-center left-[-53.99px] size-[273.98px] top-[84.51px]"
              style={
                {
                  "--transform-inner-width": "1185",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="-rotate-78 flex-none">
                <div className="relative size-[231px]">
                  <div className="absolute bottom-1/2 left-[96.12%] right-0 top-[38.29%]">
                    ...
                    >
                      <g id="Ellipse 126">
                        <mask fill="white" id="path-1-inside-1_10_549">
                          <path d={svgPaths.p308aca80} />
                        </mask>
                        <path
                          d={svgPaths.p308aca80}
                          mask="url(#path-1-inside-1_10_549)"
            ...
            <div
              className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Instrument_Sans',sans-serif] font-normal h-[6px] justify-center leading-[0] left-[calc(50%-0.25px)] text-[#8e8e93] text-[8px] text-center top-[143px] w-[40px]"
              style={{ fontVariationSettings: "'wdth' 100" }}
            >
        ...
        <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
            <Text1 text="Medication Intake" />
            <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
              <Wrapper2>
                <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                    <Text2 text="x 2" />
                    <Text3 text="Magnesium" />
                  </div>
                  <div
