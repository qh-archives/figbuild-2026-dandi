...
import svgPaths from "./svg-0ppd8ze2sv";
...
type HeartRateImageImageProps = {
  additionalClassNames?: string;
};

function HeartRateImageImage({
  additionalClassNames = "",
}: HeartRateImageImageProps) {
  return (
...
export default function IPhone() {
  return (
    <div className="app-bg relative size-full" data-name="iPhone 16 - 74">
      <div className="absolute h-[1408px] left-[-426px] top-[-189px] w-[1197px]">
        <div className="absolute inset-[-7.41%_-8.71%_-12.32%_-14.49%]">
          <svg
            className="block size-full"
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 1474.8 1685.8"
          >
            <g id="Group 32">
              <g filter="url(#filter0_f_10_559)" id="Ellipse 128">
                <ellipse
                  cx="481"
                  cy="666.8"
              ...
              <g filter="url(#filter1_f_10_559)" id="Ellipse 130">
                <circle
                  cx="1107"
                  cy="367.8"
              ...
              <g filter="url(#filter2_f_10_559)" id="Ellipse 123">
                <circle
                  cx="497.5"
                  cy="1188.3"
              ...
              <g filter="url(#filter3_f_10_559)" id="Ellipse 129">
                <ellipse
                  cx="1028"
                  cy="750.3"
              ...
              <g filter="url(#filter4_f_10_559)" id="Ellipse 131">
                <ellipse
                  cx="690.5"
                  cy="436.8"
            ...
            <defs>
              ...
              >
                ...
                />
                <feGaussianBlur
                  result="effect1_foregroundBlur_10_559"
                  stdDeviation="52.15"
                />
              </filter>
              <filter
      ...
      <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-[20px] top-[125px] w-[353px]">
        <div className="h-[348px] relative shrink-0 w-full">
          ...
          >
            <div className="absolute h-[63px] left-[17px] top-[82px] w-[135px]">
              <div className="absolute inset-[5.01%_-0.58%_-0.47%_-0.71%]">
                <svg
                  className="block size-full"
                  fill="none"
                  preserveAspectRatio="none"
                  viewBox="0 0 136.736 60.142"
                >
                  <path
                    d={svgPaths.p3a9c2900}
                    id="Vector 127"
                    stroke="url(#paint0_linear_10_586)"
                    strokeOpacity="0.75"
                    strokeWidth="2"
                  />
                  <defs>
            ...
            <div
              className="absolute flex h-[183.378px] items-center justify-center left-[57px] top-[-72px] w-[182.459px]"
              style={
                {
            ...
            >
              <div className="flex-none rotate-48">
                <HeartRateImageImage additionalClassNames="h-[123.311px] w-[135.73px]" />
              </div>
            </div>
            <div
              className="absolute flex h-[69.527px] items-center justify-center left-[255px] top-[12px] w-[74.126px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="flex-none rotate-[-11.27deg]">
                <HeartRateImageImage additionalClassNames="h-[58.141px] w-[63.996px]" />
              </div>
            </div>
            <div
              className="absolute flex h-[61.807px] items-center justify-center left-[58.13px] top-[120px] w-[63.233px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="flex-none rotate-[31.62deg]">
                <HeartRateImageImage additionalClassNames="h-[43.264px] w-[47.621px]" />
              </div>
            </div>
            <div
              className="absolute flex h-[106.083px] items-center justify-center left-[148px] top-[124px] w-[107.11px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="flex-none rotate-[-39.26deg]">
                <HeartRateImageImage additionalClassNames="h-[72.122px] w-[79.386px]" />
              </div>
            </div>
            <div
              className="absolute flex h-[87.338px] items-center justify-center left-[-15px] top-[199px] w-[86.9px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="flex-none rotate-48">
                <HeartRateImageImage additionalClassNames="h-[58.73px] w-[64.645px]" />
              </div>
            </div>
            <div
              className="absolute flex h-[66.122px] items-center justify-center left-[152px] top-[246.51px] w-[65.79px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="flex-none rotate-48">
                <HeartRateImageImage additionalClassNames="h-[44.463px] w-[48.941px]" />
              </div>
            </div>
            <div
              className="absolute flex h-[107.255px] items-center justify-center left-[45px] top-[276px] w-[106.717px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            <div
              className="absolute flex h-[75.337px] items-center justify-center left-[263px] top-[251.56px] w-[69.336px]"
              style={
                {
                  "--transform-inner-width": "1200",
                  "--transform-inner-height": "21",
            ...
            >
              <div className="flex-none rotate-[85.87deg]">
                <HeartRateImageImage additionalClassNames="h-[64.395px] w-[70.881px]" />
              </div>
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
            <Text text="Medication Intake" />
            <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
              <Wrapper2>
                <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                    <Text1 text="x 2" />
                    <Text2 text="Magnesium" />
                  </div>
                  <div
