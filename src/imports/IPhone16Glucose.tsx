...
import svgPaths from "./svg-fd31fuia2i";
...
export default function IPhone16Glucose() {
  return (
    <div
      className="app-bg relative size-full"
      data-name="iPhone 16 - glucose"
    >
      ...
      <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[32px] items-start left-1/2 top-[123px] w-[353px]">
        <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[17px] items-start relative shrink-0 w-full">
            ...
            >
              <div className="absolute h-[59px] left-[15px] top-[39px] w-[84px]">
                <div className="absolute h-[59px] left-0 top-0 w-[80px]">
                  <div
                    className="-translate-y-1/2 absolute flex flex-col font-['Instrument_Sans',sans-serif] font-normal justify-center leading-[0] left-0 text-[#494949] text-[48px] top-[29.5px] whitespace-nowrap"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    <p className="leading-[normal]">104</p>
                  </div>
                </div>
                <div className="absolute h-[20px] left-[85px] top-[31px] w-[58px]">
                  <div
                    className="-translate-y-1/2 absolute flex flex-col font-['Instrument_Sans',sans-serif] font-normal justify-center leading-[0] left-0 text-[#828282] text-[16px] top-[10px] whitespace-nowrap"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
              ...
              >
                <p className="leading-[normal]">
                  Glucose stayed within a healthy range across the full 24
                  hours, a sign of consistent metabolic balance throughout your
                  day.
                </p>
              </div>
              <div className="absolute h-[121.003px] left-[32px] top-[138px] w-[299px]">
                <div className="absolute inset-[-0.83%_0_0_-0.25%]">
                  <svg
                    className="block size-full"
                    fill="none"
                    preserveAspectRatio="none"
                    viewBox="0 0 299.739 122.002"
                  >
                    <g id="Frame 281">
                      <path
                        d={svgPaths.p1118e1c0}
                        id="Vector 127"
                        stroke="url(#paint0_linear_17_920)"
                        strokeOpacity="0.75"
                        strokeWidth="2"
                      />
                      <line
                        id="Line 15"
                        stroke="var(--stroke-0, #868A85)"
                        strokeDasharray="6 6"
                        strokeLinecap="round"
                        transform="matrix(0.999994 -0.00335525 0.00310132 0.999995 0.739385 2.00155)"
                        x1="0.5"
                        x2="298.502"
                        y1="-0.5"
                        y2="-0.5"
                      ...
                      <line
                        ...
                        strokeLinecap="round"
                        strokeWidth="1.5"
                        transform="matrix(0.999994 -0.00335525 0.00310132 0.999995 0.739385 32.0015)"
                        x1="0.75"
                        x2="298.252"
                        y1="-0.75"
                        y2="-0.75"
                      ...
                      <line
                        ...
                        strokeDasharray="6 6"
                        strokeLinecap="round"
                        transform="matrix(0.999994 -0.00335525 0.00310132 0.999995 0.739385 62.0015)"
                        x1="0.5"
                        x2="298.502"
                        y1="-0.5"
                        y2="-0.5"
                      ...
                      <line
                        ...
                        strokeLinecap="round"
                        strokeWidth="1.5"
                        transform="matrix(0.999994 -0.00335525 0.00310132 0.999995 0.739385 92.0015)"
                        x1="0.75"
                        x2="298.252"
                        y1="-0.75"
                        y2="-0.75"
                      ...
                      <line
                        ...
                        strokeDasharray="6 6"
                        strokeLinecap="round"
                        transform="matrix(0.999994 -0.00335525 0.00310132 0.999995 0.739385 122.002)"
                        x1="0.5"
                        x2="298.502"
                        y1="-0.5"
                        y2="-0.5"
              ...
              <div className="absolute font-['Instrument_Sans',sans-serif] font-normal h-[130px] leading-[0] left-[12px] text-[8px] text-right top-[133px] w-[16px] whitespace-nowrap">
                <div
                  className="-translate-x-full -translate-y-1/2 absolute flex flex-col justify-center left-[16px] text-[#868a85] top-[125px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  <p className="leading-[normal]">60</p>
                </div>
                <div
                  className="-translate-x-full -translate-y-1/2 absolute flex flex-col justify-center left-[16px] text-[#515151] top-[95px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  <p className="leading-[normal]">120</p>
                </div>
                <div
                  className="-translate-x-full -translate-y-1/2 absolute flex flex-col justify-center left-[16px] text-[#868a85] top-[65px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  <p className="leading-[normal]">180</p>
                </div>
                <div
                  className="-translate-x-full -translate-y-1/2 absolute flex flex-col justify-center left-[16px] text-[#515151] top-[35px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  <p className="leading-[normal]">240</p>
                </div>
                <div
                  className="-translate-x-full -translate-y-1/2 absolute flex flex-col justify-center left-[16px] text-[#868a85] top-[5px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
            ...
            <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full">
              <Wrapper2>
                <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                    <Text1 text="x 2" />
                    <Helper text="Magnesium" text1="500 mcg." />
                  </div>
                  <div
              ...
              <Wrapper2>
                <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
                    <Text1 text="x 2" />
                    <Helper text="Inositol" text1="500 mcg." />
                  </div>
                  <div
