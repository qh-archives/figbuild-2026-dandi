...
import svgPaths from "./svg-vyidqft03n";
...
export default function IPhone16BodyTemp() {
  return (
    <div
      className="app-bg relative size-full"
      data-name="iPhone 16 - body temp"
    >
          ...
          <div className="content-stretch flex flex-col gap-[17px] items-start relative shrink-0 w-full">
            ...
            >
              <div className="absolute h-[59px] left-[15px] top-[39px] w-[94px]">
                <div className="absolute h-[59px] left-0 top-0 w-[94px]">
                  <div
              ...
              <div className="absolute h-[40px] left-[114px] top-[46px] w-[16px]">
                <div
                  className="-translate-y-1/2 absolute flex flex-col font-['Instrument_Sans',sans-serif] font-normal justify-center leading-[0] left-0 text-[#828282] text-[16px] top-[20px] whitespace-nowrap"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
              ...
              >
                <p className="leading-[normal]">
                  Your temperature is right in the sweet spot, which points to a
                  well-rested night.
                </p>
              </div>
              <div className="absolute left-0 size-[378.98px] top-[69px]">
                <div className="absolute left-[-20px] size-[393px] top-[46px]">
                  <svg
                    className="absolute block size-full"
                    fill="none"
                    preserveAspectRatio="none"
                ...
                <div
                  className="absolute flex h-[26.869px] items-center justify-center left-[136.85px] top-[42.03px] w-[67.669px]"
                  style={
                    {
                ...
                >
                  <div className="-rotate-85 flex-none">
                    <div className="h-[66.074px] relative w-[21.191px]">
                      <svg
                        className="absolute block size-full"
                        fill="none"
                        preserveAspectRatio="none"
                        viewBox="0 0 21.1914 66.0738"
                      >
                        <path
                          d={svgPaths.p23d53600}
                          id="Ellipse 126"
                ...
                <div
                  className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Instrument_Sans',sans-serif] font-normal h-[39px] justify-center leading-[0] left-[calc(50%-12.49px)] text-[#151515] text-[24px] text-center top-[147.5px] w-[106px]"
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
